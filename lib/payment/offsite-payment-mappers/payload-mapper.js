  ...
  _createClass(PayloadMapper, [{
    ...
    value: function mapToPayload(data) {
      ...
      var payload = (0, _objectAssign2.default)({
        ...
        vault_payment_instrument: payment.shouldSaveInstrument ? payment.shouldSaveInstrument : null
      ...
      var _payment$formattedPay = payment.formattedPayload,
          formattedPayload = _payment$formattedPay === undefined ? {} : _payment$formattedPay;


      (0, _objectAssign2.default)(payload, formattedPayload);
